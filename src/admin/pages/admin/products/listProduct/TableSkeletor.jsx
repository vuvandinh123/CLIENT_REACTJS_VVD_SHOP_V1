const TableSkeletor = () => {
  return (
    <tr className="animate-pulse">
      ...
      <th className="flex items-center gap-3 px-6  py-4 ">
        <div className="font-medium bg-slate-200 w-40 h-4 rounded-md"></div>
      </th>
      <td className=" py-4 ">
        <div className="inline-flex w-20 h-3 bg-slate-200  items-center gap-1 rounded-full px-2 py-1 font-semibold text-green-600"></div>
      </td>
      <td className=" py-4 ">
