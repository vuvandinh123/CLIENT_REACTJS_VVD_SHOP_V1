    ...
    const fetchApi = async () => {
      try {
        ...
        if (response?.status === 200) {
          ...
          if (decodedToken.role !== "SHOP" && decodedToken.role !== "ADMIN") {
          ...
          console.log(decodedToken, "first_login");
          if (decodedToken.first_login === 1) {
            navigate("/seller/change-password-shop");
            return;
          }
